...
const Bubble = ({ direction })=>{
    ...
    const targetY = -220 // Float UP towards the image center
    ;
    // Add slight randomness so it's not a single file line
    const xVariation = Math.random() * 60 - 30;
    const yVariation = Math.random() * 60 - 30;
    const size = 5 + Math.random() * 10;
    const duration = 1.0 + Math.random() * 10.5 // slower, smoother
    ;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].div, {
        initial: {
            opacity: 0,
        ...
        animate: {
            ...
            y: targetY + yVariation // Move strictly to target
        },
        transition: {
            duration: duration,
            ease: "easeInOut",
            times: [
                ...
                0.2,
                1
            ] // Control timing of opacity/scale phases if needed, but default is fine usually. usage here applies to all props.
        },
        style: {
            width: size,
            height: size,
...
//# sourceMappingURL=_8ca58e51._.js.map