    ...
    >
      ...
      >
        ...
        <header
          ...
          style={{ backgroundColor: '#28617C' }}
          aria-label="Main navigation header"
        >
          <button
            ref={toggleBtnRef}
            className={`sm-toggle absolute left-8 inline-flex items-center gap-[0.5rem] bg-transparent border-0 cursor-pointer font-medium leading-none overflow-visible pointer-events-auto text-xl ${
        ...
        >
          {/* Logo in menu panel */}
          <div className="sm-panel-logo absolute top-[2em] left-[2em]">
            <img
